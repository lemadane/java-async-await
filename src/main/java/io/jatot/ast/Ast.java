...
public interface Ast {
    ...
    sealed interface Node permits TypeNode, TypeDeclaration, Member, Statement, Expression, TypeParameter, EnumConstant, Parameter, CatchClause, CompilationUnit {}
    ...
    // Statements
    sealed interface Statement extends Node permits BlockStmt, LocalVarDeclStmt, IfStmt, ForStmt, ForEachStmt, WhileStmt, DoWhileStmt, TryStmt, ReturnStmt, YieldStmt, BreakStmt, ContinueStmt, ExprStmt, ThrowStmt {}
    ...
    // Expressions
    sealed interface Expression extends Node permits LiteralExpr, IdentifierExpr, ThisExpr, SuperExpr, BinaryExpr, UnaryExpr, MemberAccessExpr, MethodCallExpr, NewObjectExpr, NewArrayExpr, ArrayInitializerExpr, ArrayAccessExpr, LambdaExpr, AsyncExpr, AwaitExpr, IfExpr, TryExpr, LoopExpr, NamedArgExpr {
